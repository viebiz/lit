...
// RegisterService provides a mock function for the type MockServiceRegistrar
func (_mock *MockServiceRegistrar) RegisterService(desc *grpc.ServiceDesc, impl any) {
	_mock.Called(desc, impl)
	return
}
...
func (_c *MockServiceRegistrar_RegisterService_Call) Run(run func(desc *grpc.ServiceDesc, impl any)) *MockServiceRegistrar_RegisterService_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *grpc.ServiceDesc
		if args[0] != nil {
			arg0 = args[0].(*grpc.ServiceDesc)
		}
		var arg1 any
		if args[1] != nil {
			arg1 = args[1].(any)
...
func (_c *MockServiceRegistrar_RegisterService_Call) RunAndReturn(run func(desc *grpc.ServiceDesc, impl any)) *MockServiceRegistrar_RegisterService_Call {
	_c.Run(run)
	return _c
}
