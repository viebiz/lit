...
// DoInBatch provides a mock function for the type MockClient
func (_mock *MockClient) DoInBatch(ctx context.Context, fn func(cmder Commander) error) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, func(cmder Commander) error) error); ok {
...
func (_c *MockClient_DoInBatch_Call) Run(run func(ctx context.Context, fn func(cmder Commander) error)) *MockClient_DoInBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 func(cmder Commander) error
		if args[1] != nil {
			arg1 = args[1].(func(cmder Commander) error)
		}
		run(
			arg0,
			arg1,
...
// GetFloat provides a mock function for the type MockClient
...
// GetInt provides a mock function for the type MockClient
...
// GetString provides a mock function for the type MockClient
...
func (_mock *MockClient) HashGetField(ctx context.Context, key string, field string, out interface{}) error {
	ret := _mock.Called(ctx, key, field, out)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, interface{}) error); ok {
		r0 = returnFunc(ctx, key, field, out)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_mock *MockClient) IncrementFloatBy(ctx context.Context, key string, value float64) (float64, error) {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, float64) error); ok {
		r1 = returnFunc(ctx, key, value)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockClient_Expecter) Publish(ctx interface{}, channel interface{}, message interface{}) *MockClient_Publish_Call {
	return &MockClient_Publish_Call{Call: _e.mock.On("Publish", ctx, channel, message)}
}
...
func (_mock *MockClient) SetFloat(ctx context.Context, key string, value float64, expiration time.Duration) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, float64, time.Duration) error); ok {
...
func (_mock *MockClient) SetInt(ctx context.Context, key string, value int64, expiration time.Duration) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, int64, time.Duration) error); ok {
		r0 = returnFunc(ctx, key, value, expiration)
	} else {
		r0 = ret.Error(0)
	}
...
func (_mock *MockClient) Subscribe(ctx context.Context, channels []string, handler MessageHandler) Subscriber {
	ret := _mock.Called(ctx, channels, handler)
	...
	var r0 Subscriber
	if returnFunc, ok := ret.Get(0).(func(context.Context, []string, MessageHandler) Subscriber); ok {
		r0 = returnFunc(ctx, channels, handler)
	} else {
		if ret.Get(0) != nil {
...
func (_e *MockClient_Expecter) Subscribe(ctx interface{}, channels interface{}, handler interface{}) *MockClient_Subscribe_Call {
	return &MockClient_Subscribe_Call{Call: _e.mock.On("Subscribe", ctx, channels, handler)}
}
...
func (_c *MockClient_Subscribe_Call) Run(run func(ctx context.Context, channels []string, handler MessageHandler)) *MockClient_Subscribe_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 MessageHandler
		if args[2] != nil {
			arg2 = args[2].(MessageHandler)
		}
		run(
			arg0,
			arg1,
