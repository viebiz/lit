...
func (_m *MockOption) Execute(s *sonyflake.Settings) error {
	ret := _m.Called(s)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*sonyflake.Settings) error); ok {
		r0 = rf(s)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockOption_Execute_Call) Run(run func(s *sonyflake.Settings)) *MockOption_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*sonyflake.Settings))
	})
	return _c
}
...
func (_c *MockOption_Execute_Call) RunAndReturn(run func(*sonyflake.Settings) error) *MockOption_Execute_Call {
	_c.Call.Return(run)
	return _c
}
